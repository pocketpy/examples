...
int main(){
    ...
    // Create a module
    PyVar math_utils = vm->new_module("math_utils");
    ...
    PyVar list = py_var(vm, std::move(numbers));

    // Call the "average" function
    PyVar f_average = math_utils->attr("average");
    PyVar result = vm->call(f_average, list);
